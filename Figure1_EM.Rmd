...
author: "Mike"
---
For plotting single traced neurons to illustrate their polarity 
...
for(i in 1:length(Cells2Plot)){
    ...
    plot3d(emmatches_JFRC2013[[index]], WithConnectors = TRUE, WithNodes = FALSE
           , lwd=1, col="black", soma=TRUE)
    plot3d(npmask.jfrc2013, alpha=0.1)
    #plot3d(JFRC2013)
    set3d("front", 0.7) #Function that sets the angle and zoom 
