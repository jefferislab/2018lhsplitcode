...
```{r, echo=FALSE}
LHON_neuropil<-readin("Figure4/Output_axonmemb_x_nc82_nc82.txt")
aheatmap(x = LHON_neuropil, filename=paste0("Figure4/LHON_neuropil.pdf")
...
aheatmap(x = LHON_LHLN, filename=paste0("Figure4/LHON_LHLN.pdf")
         ,fontsize = 9, cexRow = 2, cexCol = 5.3)
```
