...
transmitter_col<-c("red", "cyan", "green", "magenta", "yellow")
...
aheatmap(x = LHON_MBON, filename=paste0("NT_test.pdf")
         ,fontsize = 10, cexRow = 3, col="black",annRow = LHONtransmitter, annCol=MBONtransmitter, annColors  = list(transmitter_col), cexCol = 0.65, treeheight = 12, Colv = FALSE)
