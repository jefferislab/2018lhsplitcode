...
LHnts<-read.xlsx(file="/Users/mjdolan/Dropbox/JFRCvisitorProject/Neuroanatomy_Master.xlsx", sheetIndex = 1)
...
LHONtransmitter<-data.frame(Neurotransmitter=LHONtransmitter$Neurotransmitter)
...
MBONtransmitter<-data.frame(Neurotransmitter=MBONtransmitter$Neurotransmitter)

aheatmap(x = LHON_MBON, filename=paste0("NT_test.pdf")
         ,fontsize = 10, cexRow = 3, col="black",annRow = LHONtransmitter, annCol=MBONtransmitter, annColors  = "Dark2"
         ,cexCol = 0.65, treeheight = 12, Colv = FALSE)
